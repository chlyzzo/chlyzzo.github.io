 ...
 * Example:
 *
 * <figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br></pre></td><td class="code"><pre><span class="line">* <span class="keyword">var</span> result = merge(&#123;<span class="attr">foo</span>: <span class="number">123</span>&#125;, &#123;<span class="attr">foo</span>: <span class="number">456</span>&#125;);</span><br><span class="line">* <span class="built_in">console</span>.log(result.foo); <span class="comment">// outputs 456</span></span><br><span class="line">*</span><br></pre></td></tr></table></figure>
...
function upgradeToVNodes(arr, offset) {
	for (var i=offset || 0; i<arr.length; i++)="" {="" var="" obj="arr[i];" if="" (array.isarray(obj))="" upgradetovnodes(obj);="" }="" else="" (obj="" &&="" typeof="" !isvalidelement(obj)="" ((obj.props="" obj.type)="" ||="" (obj.attributes="" obj.nodename)="" obj.children))="" arr[i]="createElement(obj.type" obj.nodename,="" obj.props="" obj.attributes,="" obj.children);="" function="" isstatelesscomponent(c)="" return="" c="=='function'" !(c.prototype="" c.prototype.render);="" wraps="" stateless="" functional="" components="" in="" a="" proptypes="" validator="" wrapstatelesscomponent(wrappedcomponent)="" createclass({="" displayname:="" wrappedcomponent.displayname="" wrappedcomponent.name,="" render:="" function()="" wrappedcomponent(this.props,="" this.context);="" });="" statelesscomponenthook(ctor)="" wrapped="Ctor[COMPONENT_WRAPPER_KEY];" (wrapped)="" ?="" ctor="" :="" wrapped;="" object.defineproperty(wrapped,="" component_wrapper_key,="" configurable:true,="" value:true="" wrapped.displayname="Ctor.displayName;" wrapped.proptypes="Ctor.propTypes;" wrapped.defaultprops="Ctor.defaultProps;" object.defineproperty(ctor,="" value:wrapped="" createelement()="" args="[]," len="arguments.length;" while="" (="" len--="" )="" args[="" ]="arguments[" ];="" upgradetovnodes(args,="" 2);="" normalizevnode(__webpack_imported_module_1_preact__["h"].apply(void="" 0,="" args));="" normalizevnode(vnode)="" vnode.preactcompatnormalized="true;" applyclassname(vnode);="" (isstatelesscomponent(vnode.nodename))="" vnode.nodename="statelessComponentHook(vnode.nodeName);" ref="vnode.attributes.ref," type="ref" ref;="" (currentcomponent="" (type="=='string'" vnode.attributes.ref="createStringRefProxy(ref," currentcomponent);="" applyeventnormalization(vnode);="" vnode;="" cloneelement$1(element,="" props)="" children="[]," -="" 2;=""> 0 ) children[ len ] = arguments[ len + 2 ];
...
function collateMixins(mixins) {
	var keyed = {};
	for (var i=0; i<mixins.length; 5="" i++)="" {="" var="" mixin="mixins[i];" for="" (var="" key="" in="" mixin)="" if="" (mixin.hasownproperty(key)="" &&="" typeof="" mixin[key]="=='function')" (keyed[key]="" ||="" }="" return="" keyed;="" apply="" a="" mapping="" of="" arrays="" methods="" to="" component="" prototype="" function="" applymixins(proto,="" mixins)="" (mixins.hasownproperty(key))="" proto[key]="multihook(" mixins[key].concat(proto[key]="" arr),="" );="" bindall(ctx)="" i="" ctx)="" v="ctx[i];" (typeof="" !v.__bound="" !autobind_blacklist.hasownproperty(i))="" (ctx[i]="v.bind(ctx)).__bound" =="" true;="" callmethod(ctx,="" m,="" args)="" m="=='string')" m.apply(ctx,="" args);="" multihook(hooks,="" skipduplicates)="" function()="" arguments$1="arguments;" this$1="this;" ret;="" i<hooks.length;="" r="callMethod(this$1," hooks[i],="" arguments$1);="" (skipduplicates="" r!="null)" (!ret)="" ret="{};" r)="" (r.hasownproperty(key))="" ret[key]="r[key];" else="" };="" newcomponenthook(props,="" context)="" propshook.call(this,="" props,="" context);="" this.componentwillreceiveprops="multihook([propsHook," 'componentwillreceiveprops']);="" this.render="multihook([propsHook," beforerender,="" 'render',="" afterrender]);="" propshook(props,="" (!props)="" return;="" react="" annoyingly="" special-cases="" single="" children,="" and="" some="" components="" are="" ridiculously="" strict="" about="" this.="" c="props.children;" (c="" array.isarray(c)="" c.length="==1)" props.children="c[0];" but="" its="" totally="" still="" going="" be="" an="" array.="" (props.children="" props.children.length="1;" props.children[0]="props.children;" add="" proptype="" checking="" (dev)="" ctor="typeof" this="=='function'" ?="" :="" this.constructor,="" proptypes="this.propTypes" ctor.proptypes;="" displayname="this.displayName" ctor.name;="" (proptypes)="" __webpack_imported_module_0_prop_types___default.a.checkproptypes(proptypes,="" 'prop',="" displayname);="" beforerender(props)="" currentcomponent="this;" afterrender()="" (currentcomponent="==this)" component$1(props,="" context,="" opts)="" __webpack_imported_module_1_preact__["component"].call(this,="" this.state="this.getInitialState" this.getinitialstate()="" {};="" this.refs="{};" this._refproxies="{};" (opts!="=BYPASS_HOOK)" newcomponenthook.call(this,="" extend(component$1.prototype="new" __webpack_imported_module_1_preact__["component"](),="" constructor:="" component$1,="" isreactcomponent:="" {},="" replacestate:="" function(state,="" callback)="" this.setstate(state,="" callback);="" this$1.state)="" (!(i="" state))="" delete="" this$1.state[i];="" },="" getdomnode:="" this.base;="" ismounted:="" !!this.base;="" });="" purecomponent(props,="" component$1.call(this,="" f.prototype="Component$1.prototype;" purecomponent.prototype="new" f();="" purecomponent.prototype.ispurereactcomponent="true;" purecomponent.prototype.shouldcomponentupdate="function(props," state)="" shallowdiffers(this.props,="" props)="" shallowdiffers(this.state,="" state);="" index="{" version:="" version,="" dom:="" dom,="" proptypes:="" __webpack_imported_module_0_prop_types___default.a,="" children:="" render:="" render$1,="" createclass:="" createclass,="" createfactory:="" createfactory,="" createelement:="" createelement,="" cloneelement:="" cloneelement$1,="" isvalidelement:="" isvalidelement,="" finddomnode:="" finddomnode,="" unmountcomponentatnode:="" unmountcomponentatnode,="" component:="" purecomponent:="" purecomponent,="" unstable_rendersubtreeintocontainer:="" rendersubtreeintocontainer="" *="" harmony="" default export="" __webpack_exports__["default"]="(index);" #="" sourcemappingurl="preact-compat.es.js.map" webpack="" injection="" }.call(__webpack_exports__,="" __webpack_require__(5)))="" ***="" }),="" (function(module,="" exports)="" shim="" using="" process="" browser="" cached="" from="" whatever="" global="" is="" present="" so="" that="" test="" runners="" stub="" it="" don't="" break="" things.="" we="" need="" wrap="" try="" catch="" case="" wrapped="" mode="" code="" which="" doesn't="" define="" any="" globals.="" it's="" inside="" because="" catches="" deoptimize="" certain="" engines.="" cachedsettimeout;="" cachedcleartimeout;="" defaultsettimout()="" throw="" new="" error('settimeout="" has="" not="" been="" defined');="" defaultcleartimeout="" ()="" error('cleartimeout="" (function="" settimeout="==" 'function')="" cachedsettimeout="setTimeout;" (e)="" cleartimeout="==" cachedcleartimeout="clearTimeout;" ())="" runtimeout(fun)="" (cachedsettimeout="==" settimeout)="" normal="" enviroments="" sane="" situations="" settimeout(fun,="" 0);="" wasn't="" available="" was="" latter="" defined="" ((cachedsettimeout="==" defaultsettimout="" !cachedsettimeout)="" when="" somebody="" screwed="" with="" no="" i.e.="" maddness="" cachedsettimeout(fun,="" catch(e){="" the="" script="" evaled="" trust="" object="" called="" normally="" cachedsettimeout.call(null,="" fun,="" same="" as="" above="" version="" must="" have="" 'this',="" hopfully="" our="" context="" correct="" otherwise="" will="" error="" cachedsettimeout.call(this,="" runcleartimeout(marker)="" (cachedcleartimeout="==" cleartimeout)="" cleartimeout(marker);="" ((cachedcleartimeout="==" !cachedcleartimeout)="" cachedcleartimeout(marker);="" (e){="" cachedcleartimeout.call(null,="" marker);="" error.="" versions="" different="" rules="" vs="" cachedcleartimeout.call(this,="" queue="[];" draining="false;" currentqueue;="" queueindex="-1;" cleanupnexttick()="" (!draining="" !currentqueue)="" (currentqueue.length)="" (queue.length)="" drainqueue();="" drainqueue()="" (draining)="" timeout="runTimeout(cleanUpNextTick);" len="queue.length;" while(len)="" currentqueue="queue;" while="" (++queueindex="" <="" len)="" (currentqueue)="" currentqueue[queueindex].run();="" runcleartimeout(timeout);="" process.nexttick="function" (fun)="" args="new" array(arguments.length="" -="" 1);="" (arguments.length=""> 1) {
...
var createDict = function(){
  ...
  var iframe = __webpack_require__(29)('iframe')
    ...
    , lt     = '<' 37="" ,="" gt=">" iframedocument;="" iframe.style.display="none" ;="" __webpack_require__(57).appendchild(iframe);="" iframe.src="javascript:" eslint-disable-line="" no-script-url="" createdict="iframe.contentWindow.Object;" html.removechild(iframe);="" iframedocument="iframe.contentWindow.document;" iframedocument.open();="" iframedocument.write(lt="" +="" 'script'="" 'document.f="Object'" lt="" '="" script'="" gt);="" iframedocument.close();="" while(i--)delete="" createdict[prototype][enumbugkeys[i]];="" return="" createdict();="" };="" module.exports="Object.create" ||="" function="" create(o,="" properties){="" var="" result;="" if(o="" !="=" null){="" empty[prototype]="anObject(O);" result="new" empty;="" add="" "__proto__"="" for="" object.getprototypeof="" polyfill="" result[ie_proto]="O;" }="" else="" properties="==" undefined="" ?="" :="" dps(result,="" properties);="" ***="" }),="" *="" (function(module,="" exports,="" __webpack_require__)="" {="" 7.1.15="" tolength="" tointeger="__webpack_require__(34)" min="Math.min;" it=""> 0 ? min(toInteger(it), 0x1fffffffffffff) : 0; // pow(2, 53) - 1 == 9007199254740991
};
...
!function() {
    ...
    function innerDiffNode(dom, vchildren, context, mountAll, isHydrating) {
        ...
        while (min <= 0="" 1="==" 84="" 85="" 410="" 2014="" childrenlen)="" if="" (void="" !="=" (child="children[childrenLen--]))" recollectnodetree(child,="" !1);="" }="" function="" recollectnodetree(node,="" unmountonly)="" {="" var="" component="node._component;" (component)="" unmountcomponent(component);="" else="" (null="" &&="" node.__preactattr_.ref)="" node.__preactattr_.ref(null);="" (unmountonly="==" !1="" ||="" null="=" node.__preactattr_)="" removenode(node);="" removechildren(node);="" removechildren(node)="" node="node.lastChild;" while="" (node)="" next="node.previousSibling;" !0);="" diffattributes(dom,="" attrs,="" old)="" name;="" for="" (name="" in="" ((!attrs="" attrs[name])="" setaccessor(dom,="" name,="" old[name],="" old[name]="void" 0,="" issvgmode);="" attrs)="" (!('children'="==" name="" 'innerhtml'="==" old="" attrs[name]="==" ('value'="==" 'checked'="==" ?="" dom[name]="" :="" old[name])))="" collectcomponent(component)="" (components[name]="" createcomponent(ctor,="" props,="" context)="" inst,="" list="components[Ctor.name];" (ctor.prototype="" ctor.prototype.render)="" inst="new" ctor(props,="" context);="" component.call(inst,="" component(props,="" inst.constructor="Ctor;" inst.render="doRender;" (list)="" (var="" i="list.length;" i--;="" )="" (list[i].constructor="==" ctor)="" inst.__b="list[i].__b;" list.splice(i,="" 1);="" break;="" return="" inst;="" dorender(props,="" state,="" this.constructor(props,="" setcomponentprops(component,="" opts,="" context,="" mountall)="" (!component.__x)="" component.__x="!0;" (component.__r="props.ref)" delete="" props.ref;="" (component.__k="props.key)" props.key;="" (!component.base="" (component.componentwillmount)="" component.componentwillmount();="" (component.componentwillreceiveprops)="" component.componentwillreceiveprops(props,="" (context="" context="" component.context)="" (!component.__c)="" component.__c="component.context;" component.context="context;" (!component.__p)="" component.__p="component.props;" component.props="props;" (0="" opts)="" (1="==" opts="" options.synccomponentupdates="" !component.base)="" rendercomponent(component,="" 1,="" mountall);="" enqueuerender(component);="" (component.__r)="" component.__r(component);="" mountall,="" ischild)="" rendered,="" cbase,="" props="component.props," state="component.state," previousprops="component.__p" previousstate="component.__s" previouscontext="component.__c" isupdate="component.base," nextbase="component.__b," initialbase="isUpdate" nextbase,="" initialchildcomponent="component._component," skip="!1;" (isupdate)="" component.state="previousState;" (2="" component.shouldcomponentupdate="" component.shouldcomponentupdate(props,="" !1)="" (component.componentwillupdate)="" component.componentwillupdate(props,="" =="" null;="" component.__d="!1;" (!skip)="" rendered="component.render(props," (component.getchildcontext)="" context),="" component.getchildcontext());="" tounmount,="" base,="" childcomponent="rendered" rendered.nodename;="" ('function'="=" typeof="" childcomponent)="" childprops="getNodeProps(rendered);" (inst="" childprops.key="=" inst.__k)="" setcomponentprops(inst,="" childprops,="" tounmount="inst;" component._component="inst" createcomponent(childcomponent,="" nextbase;="" inst.__u="component;" rendercomponent(inst,="" base="inst.base;" cbase="initialBase;" (tounmount)="" (initialbase="" (cbase)="" cbase._component="null;" mountall="" !isupdate,="" initialbase.parentnode,="" initialchildcomponent)="" baseparent="initialBase.parentNode;" (baseparent="" baseparent)="" baseparent.replacechild(base,="" initialbase);="" (!tounmount)="" initialbase._component="null;" recollectnodetree(initialbase,="" unmountcomponent(tounmount);="" component.base="base;" (base="" !ischild)="" componentref="component," t="component;" (t="t.__u)" (componentref="t).base" base;="" base._component="componentRef;" base._componentconstructor="componentRef.constructor;" (!isupdate="" mounts.unshift(component);="" flushmounts();="" (component.componentdidupdate)="" component.componentdidupdate(previousprops,="" previousstate,="" previouscontext);="" (options.afterupdate)="" options.afterupdate(component);="" (component.__h.length)="" component.__h.pop().call(component);="" (!difflevel="" buildcomponentfromvnode(dom,="" vnode,="" c="dom" dom._component,="" originalcomponent="c," olddom="dom," isdirectowner="c" dom._componentconstructor="==" vnode.nodename,="" isowner="isDirectOwner," (c="" !isowner="" vnode.nodename;="" (!mountall="" c._component))="" setcomponentprops(c,="" 3,="" dom="c.base;" (originalcomponent="" !isdirectowner)="" unmountcomponent(originalcomponent);="" (dom="" !c.__b)="" c.__b="dom;" (olddom="" olddom)="" olddom._component="null;" recollectnodetree(olddom,="" dom;="" unmountcomponent(component)="" (options.beforeunmount)="" options.beforeunmount(component);="" (component.componentwillunmount)="" component.componentwillunmount();="" inner="component._component;" (inner)="" unmountcomponent(inner);="" (base)="" (base.__preactattr_="" base.__preactattr_.ref)="" base.__preactattr_.ref(null);="" component.__b="base;" removenode(base);="" collectcomponent(component);="" removechildren(base);="" component.__r(null);="" this.__d="!0;" this.context="context;" this.props="props;" this.state="this.state" {};="" render(vnode,="" parent,="" merge)="" diff(merge,="" {},="" !1,="" options="{};" stack="[];" empty_children="[];" is_non_dimensional="/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i;" items="[];" mounts="[];" difflevel="0;" issvgmode="!1;" hydrating="!1;" components="{};" extend(component.prototype,="" setstate:="" function(state,="" callback)="" s="this.state;" (!this.__s)="" this.__s="extend({}," s);="" extend(s,="" 'function'="=" state(s,="" this.props)="" state);="" (callback)="" (this.__h="this.__h" []).push(callback);="" enqueuerender(this);="" },="" forceupdate:="" function(callback)="" rendercomponent(this,="" 2);="" render:="" function()="" {}="" });="" preact="{" h:="" h,="" createelement:="" cloneelement:="" cloneelement,="" component:="" component,="" render,="" rerender:="" rerender,="" options:="" };="" (true)="" module.exports="preact;" self.preact="preact;" }();="" #="" sourcemappingurl="preact.js.map" ***="" }),="" *="" (function(module,="" exports,="" __webpack_require__)="" "use="" strict";="" this="" file="" can="" be="" required browserify="" and="" node.js="" automatic="" polyfill="" to="" use="" it:="" require('es6-promise="" auto');="" webpack="" injection="" (function(process,="" global)="" {var="" require;="" *!="" @overview="" es6-promise="" -="" a="" tiny="" implementation="" of="" promises="" a+.="" @copyright="" copyright="" (c)="" yehuda="" katz,="" tom="" dale,="" stefan="" penner="" contributors="" (conversion="" es6="" api="" by="" jake="" archibald)="" @license="" licensed="" under="" mit="" license="" see="" https:="" raw.githubusercontent.com="" stefanpenner="" master="" @version="" 4.1.1="" (function="" (global,="" factory)="" true="" define="==" define.amd="" define(factory)="" (global.es6promise="factory());" }(this,="" ()="" 'use="" strict';="" objectorfunction(x)="" type="typeof" x;="" x="" (type="==" 'object'="" 'function');="" isfunction(x)="" 'function';="" _isarray="undefined;" (array.isarray)="" (x)="" object.prototype.tostring.call(x)="==" '[object="" array]';="" isarray="_isArray;" len="0;" vertxnext="undefined;" customschedulerfn="undefined;" asap="function" asap(callback,="" arg)="" queue[len]="callback;" queue[len="" +="" 1]="arg;" (len="==" 2)="" is="" 2,="" that="" means="" we="" need="" schedule="" an="" async flush.="" additional="" callbacks="" are="" queued="" before="" the="" queue="" flushed,="" they="" will="" processed="" flush="" scheduling.="" (customschedulerfn)="" customschedulerfn(flush);="" scheduleflush();="" setscheduler(schedulefn)="" setasap(asapfn)="" browserwindow="typeof" window="" 'undefined'="" undefined;="" browserglobal="browserWindow" browsermutationobserver="browserGlobal.MutationObserver" browserglobal.webkitmutationobserver;="" isnode="typeof" self="==" process="" ({}).tostring.call(process)="==" process]';="" test="" web="" worker="" but="" not="" ie10="" isworker="typeof" uint8clampedarray="" importscripts="" messagechannel="" 'undefined';="" usenexttick()="" version="" 0.10.x="" displays="" deprecation="" warning="" when="" nexttick="" used="" recursively="" github.com="" cujojs="" issues="" details="" process.nexttick(flush);="" vertx="" usevertxtimer()="" (typeof="" 'undefined')="" vertxnext(flush);="" usesettimeout();="" usemutationobserver()="" iterations="0;" observer="new" browsermutationobserver(flush);="" observer.observe(node,="" characterdata:="" node.data="iterations" ++iterations="" %="" 2;="" usemessagechannel()="" channel="new" messagechannel();="" channel.port1.onmessage="flush;" channel.port2.postmessage(0);="" usesettimeout()="" store="" settimeout="" reference="" so="" unaffected="" other="" code="" modifying="" (like="" sinon.usefaketimers())="" globalsettimeout="setTimeout;" globalsettimeout(flush,="" array(1000);="" flush()="" <="" len;="" callback="queue[i];" arg="queue[i" 1];="" callback(arg);="" queue[i]="undefined;" queue[i="" attemptvertx()="" try="" r="require;" vertx.runoncontext;="" usevertxtimer();="" catch="" (e)="" scheduleflush="undefined;" decide="" what="" method="" triggering="" processing="" callbacks:="" (isnode)="" (browsermutationobserver)="" (isworker)="" (browserwindow="==" undefined="" "function"="==" 'function')="" then(onfulfillment,="" onrejection)="" _arguments="arguments;" parent="this;" child="new" this.constructor(noop);="" (child[promise_id]="==" undefined)="" makepromise(child);="" _state="parent._state;" (_state)="" asap(function="" invokecallback(_state,="" child,="" callback,="" parent._result);="" })();="" subscribe(parent,="" onfulfillment,="" onrejection);="" child;="" **="" `promise.resolve`="" returns="" promise="" become="" resolved="" with="" passed="" `value`.="" it="" shorthand="" following:="" <figure="" class="highlight javascript"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br><span class="line">6</span><br><span class="line">7</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">let</span> promise = <span class="keyword">new</span> <span class="built_in">Promise</span>(<span class="function"><span class="keyword">function</span>(<span class="params">resolve, reject</span>)</span>&#123;</span><br><span class="line">  resolve(<span class="number">1</span>);</span><br><span class="line">&#125;);</span><br><span class="line"></span><br><span class="line">promise.then(<span class="function"><span class="keyword">function</span>(<span class="params">value</span>)</span>&#123;</span><br><span class="line">  <span class="comment">// value === 1</span></span><br><span class="line">&#125;);</span><br></pre></td></tr></table>
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('p', { dangerouslySetInnerHTML: {
            __html: this.i18n.t('no-found-related', {
              link: '<a href="https://github.com/' + owner + '/' + repo + '/issues" target="_blank" rel="noopener">Issues</a>'
            })
          } }),
        _react2.default.createElement(
          'p',
...
if(!USE_NATIVE){
  ...
  Internal = function Promise(executor){
    this._c = [];             // <- 0="" 1="" 2="" 100="" 101="" awaiting="" reactions="" this._a="undefined;" <-="" checked in="" isunhandled="" this._s="0;" state="" this._d="false;" done="" this._v="undefined;" value="" this._h="0;" rejection="" state,="" -="" default,="" handled,="" unhandled="" this._n="false;" notify="" };="" internal.prototype="__webpack_require__(105)($Promise.prototype," {="" 25.4.5.3="" promise.prototype.then(onfulfilled,="" onrejected)="" then:="" function="" then(onfulfilled,="" onrejected){="" var="" reaction="newPromiseCapability(speciesConstructor(this," $promise));="" reaction.ok="typeof" onfulfilled="=" 'function'="" ?="" :="" true;="" reaction.fail="typeof" onrejected="=" &&="" onrejected;="" reaction.domain="isNode" process.domain="" undefined;="" this._c.push(reaction);="" if(this._a)this._a.push(reaction);="" if(this._s)notify(this,="" false);="" return="" reaction.promise;="" },="" 25.4.5.1="" promise.prototype.catch(onrejected)="" 'catch':="" function(onrejected){="" this.then(undefined,="" onrejected);="" }="" });="" promisecapability="function(){" promise="new" internal;="" this.promise="promise;" this.resolve="ctx($resolve," promise,="" 1);="" this.reject="ctx($reject," $export($export.g="" +="" $export.w="" $export.f="" *="" !use_native,="" {promise:="" $promise});="" __webpack_require__(25)($promise,="" promise);="" __webpack_require__(106)(promise);="" wrapper="__webpack_require__(0)[PROMISE];" statics="" $export($export.s="" 25.4.4.5="" promise.reject(r)="" reject:="" reject(r){="" capability="newPromiseCapability(this)" ,="" $$reject="capability.reject;" $$reject(r);="" capability.promise;="" (library="" ||="" !use_native),="" 25.4.4.6="" promise.resolve(x)="" resolve:="" resolve(x){="" instanceof="" instead="" of="" internal="" slot="" check="" because="" we="" should="" fix="" it="" without="" replacement="" native="" core="" if(x="" $promise="" sameconstructor(x.constructor,="" this))return="" x;="" $$resolve="capability.resolve;" $$resolve(x);="" !(use_native="" __webpack_require__(62)(function(iter){="" $promise.all(iter)['catch'](empty);="" })),="" 25.4.4.1="" promise.all(iterable)="" all:="" all(iterable){="" c="this" resolve="capability.resolve" reject="capability.reject;" abrupt="perform(function(){" values="[]" index="0" remaining="1;" forof(iterable,="" false,="" function(promise){="" $index="index++" alreadycalled="false;" values.push(undefined);="" remaining++;="" c.resolve(promise).then(function(value){="" if(alreadycalled)return;="" values[$index]="value;" --remaining="" resolve(values);="" reject);="" if(abrupt)reject(abrupt.error);="" 25.4.4.4="" promise.race(iterable)="" race:="" race(iterable){="" c.resolve(promise).then(capability.resolve,="" ***="" }),="" (function(module,="" exports)="" module.exports="function(it," constructor,="" name,="" forbiddenfield){="" if(!(it="" constructor)="" (forbiddenfield="" !="=" undefined="" forbiddenfield="" it)){="" throw="" typeerror(name="" ':="" incorrect="" invocation!');="" it;="" exports,="" __webpack_require__)="" ctx="__webpack_require__(13)" call="__webpack_require__(59)" isarrayiter="__webpack_require__(60)" anobject="__webpack_require__(8)" tolength="__webpack_require__(37)" getiterfn="__webpack_require__(42)" break="{}" exports="module.exports" =="" function(iterable,="" entries,="" fn,="" that,="" iterator){="" iterfn="ITERATOR" function(){="" iterable;="" getiterfn(iterable)="" f="ctx(fn," entries="" 1)="" length,="" step,="" iterator,="" result;="" if(typeof="" )throw="" typeerror(iterable="" '="" is="" not="" iterable!');="" fast="" case="" for="" arrays="" with="" default iterator="" if(isarrayiter(iterfn))for(length="toLength(iterable.length);" length=""> index; index++){
...
var statelessFunctionalComponentSupplied = exports.statelessFunctionalComponentSupplied = warnOnce('\n>> Error, via react-flip-move <<\n\nyou provided="" a="" stateless="" functional="" component="" as="" child="" to="" <flipmove="">. Unfortunately, SFCs aren\'t supported, because Flip Move needs access to the backing instances via refs, and SFCs don\'t have a public instance that holds that info.\n\nPlease wrap your components in a native element (eg. <div>), or a non-functional component.\n');

var invalidTypeForTimingProp = exports.invalidTypeForTimingProp = function invalidTypeForTimingProp(args) {
  return console.error('\n>> Error, via react-flip-move <<\n\nthe prop="" you="" provided="" for="" \''="" +="" args.prop="" '\'="" is="" invalid.="" it="" needs="" to="" be="" a="" positive="" integer,="" or="" string="" that="" can="" resolved="" number.="" the="" value="" args.value="" '\'.\n\nas="" result,="" default this="" parameter="" will="" used,="" which="" args.defaultvalue="" '\'.\n');="" };="" var="" deprecateddisableanimations="exports.deprecatedDisableAnimations" =="" warnonce('\n="">> Warning, via react-flip-move <<\n\nthe \'disableanimations\'="" prop="" you="" provided="" is="" deprecated.="" please="" switch="" to="" use="" \'disableallanimations\'.\n\nthis="" will="" become="" a="" silent="" error="" in="" future="" versions="" of="" react-flip-move.\n');="" var="" invalidenterleavepreset="exports.invalidEnterLeavePreset" =="" function="" invalidenterleavepreset(args)="" {="" return="" console.error('\n="">> Error, via react-flip-move <<\n\nthe 0="" 140="" 141="" enter="" leave="" preset="" you="" provided="" is="" invalid.="" we="" don\'t="" currently="" have="" a="" \''="" +="" args.value="" '="" preset.\'\n\nacceptable="" values="" are="" args.acceptablevalues="" '.="" the="" default value="" of="" args.defaultvalue="" '\'="" will="" be="" used.\n');="" };="" ***="" }),="" *="" (function(module,="" exports,="" __webpack_require__)="" {="" "use="" strict";="" object.defineproperty(exports,="" "__esmodule",="" value:="" true="" });="" var="" enterpresets="exports.enterPresets" =="" elevator:="" from:="" transform:="" 'scale(0)',="" opacity:="" '0'="" },="" to:="" '',="" ''="" }="" fade:="" accordionvertical:="" 'scaley(0)',="" transformorigin:="" 'center="" top'="" accordionhorizontal:="" 'scalex(0)',="" 'left="" center'="" none:="" null="" **="" react="" flip="" move="" |="" enterleavepresets="" (c)="" 2016-present="" joshua="" comeau="" this="" contains="" master="" list="" presets="" available="" for="" animations,="" along="" with="" mapping="" between="" and="" styles.="" leavepresets="exports.leavePresets" 'scale(1)',="" '1'="" 'scaley(1)',="" 'scalex(1)',="" now,="" appearpresets="" identical="" to="" enterpresets.="" assigning="" custom="" export="" in="" case="" ever="" want="" add="" appear-specific="" ones.="" enterpresets;="" embarrassingly="" enough,="" v2.0="" launched="" typo'ed="" names.="" avoid="" penning="" new="" major="" version="" over="" something="" so="" inconsequential,="" we're="" supporting="" both="" spellings.="" future="" version,="" these="" alternatives="" may="" deprecated.="" $flowfixme="" enterpresets.accordianvertical="enterPresets.accordionVertical;" enterpresets.accordianhorizontal="enterPresets.accordionHorizontal;" leavepresets.accordianvertical="leavePresets.accordionVertical;" leavepresets.accordianhorizontal="leavePresets.accordionHorizontal;" defaultpreset="exports.defaultPreset" 'elevator';="" disablepreset="exports.disablePreset" 'none';="" exports.createtransitionstring="exports.getNativeNode" exports.updateheightplaceholder="exports.removeNodeFromDOMFlow" exports.getpositiondelta="exports.getRelativeBoundingBox" undefined;="" _extends="Object.assign" ||="" function="" (target)="" (var="" i="1;" <="" arguments.length;="" i++)="" source="arguments[i];" key="" source)="" if="" (object.prototype.hasownproperty.call(source,="" key))="" target[key]="source[key];" return="" target;="" methods="" read="" from="" write="" dom.="" they="" almost="" always="" side="" effects,="" hopefully="" become="" only="" spot="" codebase="" impure="" functions.="" exports.applystylestodomnode="applyStylesToDOMNode;" exports.whichtransitionevent="whichTransitionEvent;" _reactdom="__webpack_require__(4);" _helpers="__webpack_require__(46);" _defineproperty(obj,="" key,="" value)="" (key="" obj)="" object.defineproperty(obj,="" value,="" enumerable:="" true,="" configurable:="" writable:="" else="" obj[key]="value;" obj;="" applystylestodomnode(_ref)="" domnode="_ref.domNode," styles="_ref.styles;" can't="" just="" do="" an="" object="" merge="" because="" domnode.styles="" no="" regular="" object.="" need="" it="" way="" engine="" fire="" its="" `set`="" listeners.="" object.keys(styles).foreach(function="" (key)="" domnode.style.setproperty((0,="" _helpers.hyphenate)(key),="" styles[key]);="" modified="" modernizr="" whichtransitionevent()="" transitions="{" transition:="" 'transitionend',="" '-o-transition':="" 'otransitionend',="" '-moz-transition':="" '-webkit-transition':="" 'webkittransitionend'="" running="" browserless="" environment="" (eg.="" ssr),="" doesn't="" apply.="" placeholder="" string,="" consistent="" type="" return.="" (typeof="" document="==" 'undefined')="" '';="" el="document.createElement('fakeelement');" match="Object.keys(transitions).find(function" (t)="" el.style.getpropertyvalue(t)="" !="=" `transition`="" found,="" must="" browser="" ancient,="" itself="" won't="" run.="" empty="" ?="" transitions[match]="" :="" getrelativeboundingbox="exports.getRelativeBoundingBox" getrelativeboundingbox(_ref2)="" childdomnode="_ref2.childDomNode," parentdomnode="_ref2.parentDomNode," getposition="_ref2.getPosition;" parentbox="getPosition(parentDomNode);" _getposition="getPosition(childDomNode)," top="_getPosition.top," left="_getPosition.left," right="_getPosition.right," bottom="_getPosition.bottom," width="_getPosition.width," height="_getPosition.height;" top:="" -="" parentbox.top,="" left:="" parentbox.left,="" right:="" parentbox.right="" right,="" bottom:="" parentbox.bottom="" bottom,="" width:="" width,="" height:="" getpositiondelta="" method="" returns="" delta="" two="" bounding="" boxes,="" figure="" out="" how="" many="" pixels="" on="" each="" axis="" element="" has="" moved.="" getpositiondelta(_ref3)="" childboundingbox="_ref3.childBoundingBox," parentboundingbox="_ref3.parentBoundingBox," temp:="" mystery="" bug="" sometimes="" causing="" unnecessary="" boundingboxes="" defaultbox="{" 0,="" our="" old="" box="" last="" calculated="" position,="" derived="" mount="" or="" at="" start="" previous="" animation.="" oldrelativebox="childBoundingBox" defaultbox;="" final="" resting="" place:="" where="" expect="" wind="" up="" after="" first="" get="" absolute="" terms="" (aka="" relative="" viewport),="" then="" calculate="" (relative="" parent="" container)="" newabsolutebox="getPosition(childDomNode);" newrelativebox="{" newabsolutebox.top="" newabsolutebox.left="" parentbox.left="" [oldrelativebox.left="" newrelativebox.left,="" oldrelativebox.top="" newrelativebox.top];="" removenodefromdomflow="" does="" very="" sneaky:="" removes="" dom="" node="" flow,="" but="" without="" actually="" changing="" on-screen="" position.="" works="" by="" calculating="" is,="" applying="" that="" winds="" being="" positioned="" absolutely,="" exactly="" same="" place.="" vital="" part="" technique.="" removenodefromdomflow(childdata,="" verticalalignment)="" boundingbox="childData.boundingBox;" (!domnode="" !boundingbox)="" return;="" work,="" offset="" any="" given="" `margin`.="" computed="window.getComputedStyle(domNode);" clean="" margins,="" converting="" removing="" suffix:="" eg.="" '21px'=""> 21
...
(function(root, factory) {
  ...
  var pluralTypes = {
    ...
    russian:   function(n) { return n % 10 === 1 && n % 100 !== 11 ? 0 : n % 10 >= 2 && n % 10 <= 4="" 10="" 100="" &&="" (n="" %="" <="" ||="" n="">= 20) ? 1 : 2; },
    czech:     function(n) { return (n === 1) ? 0 : (n >= 2 && n <= 0="" 1="" 10="" 4)="" ?="" :="" 2;="" },="" polish:="" function(n)="" {="" return="" (n="==" n="" %="">= 2 && n % 10 <= 4="" 10="" 100="" &&="" (n="" %="" <="" ||="" n="">= 20) ? 1 : 2); },
 ...
 *
 * <figure class="highlight plain"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br></pre></td><td class="code"><pre><span class="line">* Date: Wed, 27 Aug 2014 08:58:49 GMT</span><br><span class="line">* Content-Type: application/json</span><br><span class="line">* Connection: keep-alive</span><br><span class="line">* Transfer-Encoding: chunked</span><br><span class="line">*</span><br></pre></td></tr></table></figure>
...
// btoa polyfill for IE<10 1="" 8="" courtesy="" https:="" github.com="" davidchambers="" base64.js="" var="" chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=" ;="" function="" e()="" {="" this.message="String contains an invalid character" }="" e.prototype="new" error;="" e.prototype.code="5;" e.prototype.name="InvalidCharacterError" btoa(input)="" str="String(input);" output="" for="" (="" initialize="" result="" and="" counter="" block,="" charcode,="" idx="0," map="chars;" if="" the="" next="" index="" does="" not="" exist:="" change="" mapping="" table="" to="" "="
    //   check if d has no fractional digits
    str.charAt(idx | 0) || (map = '=', idx % 1);
    // " -="" %="" *="" 8"="" generates="" sequence="" 2,="" 4,="" 6,="" +="map.charAt(63" &="" block="">> 8 - idx % 1 * 8)
  ) {
 ...
 *
 *  <figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br></pre></td><td class="code"><pre><span class="line">*  <span class="function"><span class="keyword">function</span> <span class="title">f</span>(<span class="params">x, y, z</span>) </span>&#123;&#125;</span><br><span class="line">*  <span class="keyword">var</span> args = [<span class="number">1</span>, <span class="number">2</span>, <span class="number">3</span>];</span><br><span class="line">*  f.apply(<span class="literal">null</span>, args);</span><br><span class="line">*</span><br></pre></td></tr></table></figure>

 *
 * With `spread` this example can be re-written.
 *
 *  <figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br></pre></td><td class="code"><pre><span class="line">*  spread(<span class="function"><span class="keyword">function</span>(<span class="params">x, y, z</span>) </span>&#123;&#125;)([<span class="number">1</span>, <span class="number">2</span>, <span class="number">3</span>]);</span><br><span class="line">*</span><br></pre></td></tr></table></figure>
...
module.exports = "<svg 0="" 1024="" viewbox="\"0" 1024\"="" xmlns="\"http://www.w3.org/2000/svg\"" p-id="\"1619\""><path 0="" d="\"M511.872" 676.8c-0.003="" 0-0.006="" 0-0.008="" 0-9.137="" 0-17.379-3.829-23.21-9.97l-251.277-265.614c-5.415-5.72-8.743-13.464-8.744-21.984="" 0-17.678="" 14.33-32.008="" 32.008-32.008="" 9.157="" 17.416="" 3.845="" 23.25="" 10.009l228.045="" 241.103="" 228.224-241.088c5.855-6.165="" 14.113-10.001="" 23.266-10.001="" 8.516="" 16.256="" 3.32="" 21.998="" 8.736="" 12.784="" 12.145="" 13.36="" 32.434="" 1.264="" 45.233l-251.52="" 265.6c-5.844="" 6.155-14.086="" 9.984-23.223="" 9.984-0.025="" 0-0.051="" 0-0.076="" 0z\"="" p-id="\"1620\""/></svg>"

/***/ }),
/* 186 */
/***/ (function(module, exports) {

module.exports = "<svg 0="" 1024="" viewbox="\"0" 1024\"="" xmlns="\"http://www.w3.org/2000/svg\"">\n  <path 256="" 384="" 640="" 768="" 796="" d="\"M785.333333" 85.333333c774.666667="" 85.333333="" 763.2="" 90.133333="" 754.666667="" 98.666667l682.666667="" 170.666667="" 853.333333="" 341.333333="" 925.333333="" 269.333333c942.4="" 252.266667="" 942.4="" 222.133333="" 209.333333l814.666667="" 98.666667c806.133333="" 785.333333="" 85.333333zm640="" 217.333333="" 938.666667="" 806.666667="" 217.333333z\"=""/>\n</svg>\n"

/***/ }),
/* 187 */
/***/ (function(module, exports) {

module.exports = "<svg 0="" 1024="" viewbox="\"0" 1024\"="" version="\"1.1\"" xmlns="\"http://www.w3.org/2000/svg\"">\n  <path 64="" 76="" 215="" 223="" 247="" 293="" 384="" 512="" 524="" 640="" 802="" 953="" 960="" d="\"M64" 524c64="" 719.602="" 189.356="" 885.926="" 364.113="" 947.017="" 387.65799="" 936.115="" 924.767l384="" 847.107c248.118="" 863.007="" 242.674="" 773.052="" 233.5="" 758.001="" 726.501="" 171.5="" 718.501="" 184.5="" 703.501="" 215.5="" 687.501="" 707.501="" 283.5="" 761.501="" 309.956="" 800.642="" 361.366="" 794.075="" 387.658="" 787.497="" 393.403="" 763.997="" 405.637="" 743.042="" 422.353="" 726.638="" 281.774="" 701.609="" 615.67="" 513.5="" 464.053="" 239.322="" 418.406="" 271.465="" 381.627="" 251.142="" 320.928="" 273.421="" 269.19="" 276.337="" 261.415="" 334.458="" 256.131="" 394.888="" 302.993="" 399.549="" 306.685="" 432.663="" 297.835="" 470.341="" 512.5="" 554.924="" 592.81="" 297.896="" 626.075="" 306.853="" 637.426="" 298.219="" 693.46="" 258.054="" 747.5="" 262.966="" 750.382="" 270.652="" 772.185="" 321.292="" 753.058="" 381.083="" 785.516="" 417.956="" 463.809="" 615.874="" 742.99="" 701.953="" 601.803="" 726.786="" 625.381="" 750.003="" 782.295="" 818.008l640="" 930.653c640.752="" 939.626="" 948.664978="" 655.086="" 948.665="" 832.344="" 888.962="" 721.389="" 276.576="" 759.424="" 264.577="" 524z\"=""/>\n</svg>\n"

/***/ }),
/* 188 */
/***/ (function(module, exports) {

module.exports = "<svg 0="" 1024="" viewbox="\"0" 1024\"="" version="\"1.1\"" xmlns="\"http://www.w3.org/2000/svg\"" xmlns:xlink="\"http://www.w3.org/1999/xlink\"">\n  <path 0="" 1="" 192="" d="\"M527.061333" 166.528a277.333333="" 277.333333="" 1000.618667="" 362.666667a277.333333="" 1-81.28="" 196.138666l-377.173334="" 377.173334a42.666667="" 42.666667="" 1-60.330666="" 0l-377.173334-377.173334a277.376="" 277.376="" 392.277334-392.277333l15.061333="" 15.061333="" 15.061333-15.061333z="" m286.72="" 377.173333l45.226667-45.226666a192="" 0-135.808-327.893334="" 0-135.808="" 56.32l-45.226667="" 45.226667a42.666667="" 0l-45.226667-45.226667a192.042667="" 192.042667="" 0-271.616="" 271.573334l512="" 845.482667l301.781333-301.781334z\"=""/>\n</svg>\n"

/***/ }),
/* 189 */
/***/ (function(module, exports) {

module.exports = "<svg 0="" 1024="" t="\"1512463363724\"" viewbox="\"0" 1024\"="" version="\"1.1\"" xmlns="\"http://www.w3.org/2000/svg\"" xmlns:xlink="\"http://www.w3.org/1999/xlink\"">\n  <path 0="" 1="" d="\"M527.061333" 166.528a277.333333="" 277.333333="" 1000.618667="" 362.666667a277.333333="" 1-81.28="" 196.138666l-377.173334="" 377.173334a42.666667="" 42.666667="" 1-60.330666="" 0l-377.173334-377.173334a277.376="" 277.376="" 392.277334-392.277333l15.061333="" 15.061333="" 15.061333-15.061333z\"=""/>\n</svg>\n"

/***/ }),
/* 190 */
/***/ (function(module, exports) {

module.exports = "<svg 0="" 1332="" viewbox="\"0" 1024\"="" version="\"1.1\"" xmlns="\"http://www.w3.org/2000/svg\"">\n  <path 0="" 1024="" 1280="" d="\"M529.066665" 273.066666="" 529.066665="" 51.2="" 477.866666="" 955.733335="" 675.84c870.4="" 675.84="" 1109.333335="" 785.066665="" 1211.733335="" 682.666665="" 1006.933335="" 341.333334="" 273.066666\"=""/>\n</svg>\n"

/***/ }),
/* 191 */
/***/ (function(module, exports) {

module.exports = "<svg 0="" 1024="" viewbox="\"0" 1024\"="" version="\"1.1\"" xmlns="\"http://www.w3.org/2000/svg\"">\n  <path 0="" 512="" d="\"M512" 366.949535c-16.065554="" 0-29.982212="" 13.405016-29.982212="" 29.879884l0="" 359.070251c0="" 16.167882="" 13.405016="" 29.879884="" 29.982212="" 15.963226="" 29.879884-13.405016="" 29.879884-29.879884l541.879884="" 396.829419c541.879884="" 380.763865="" 528.474868="" 366.949535="" 366.949535l512="" 366.949535z\"\n="" p-id="\"3083\""/>\n  <path 0="" d="\"M482.017788" 287.645048c0-7.776956="" 3.274508-15.553912="" 8.80024-21.181973="" 5.525732-5.525732="" 13.302688-8.80024="" 21.181973-8.80024="" 7.776956="" 15.553912="" 3.274508="" 21.079644="" 8.80024="" 5.525732="" 5.62806="" 13.405016="" 21.181973="" 7.776956-3.274508="" 15.656241-8.80024="" 21.181973-5.525732="" 5.525732-13.405016="" 8.697911-21.079644="" 8.697911-7.879285="" 0-15.656241-3.274508-21.181973-8.697911c485.292295="" 303.301289="" 482.017788="" 295.524333="" 287.645048l482.017788="" 287.645048z\"\n="" p-id="\"3084\""/>\n  <path 0="" 512="" d="\"M512" 946.844409c-239.8577="" 0-434.895573-195.037873-434.895573-434.895573="" 0-239.8577="" 195.037873-434.895573="" 434.895573-434.895573="" 239.755371="" 434.895573="" 195.037873="" 434.895573c946.895573="" 751.806535="" 751.755371="" 946.844409="" 946.844409zm512="" 126.17088c-212.740682="" 0-385.880284="" 173.037274-385.880284="" 385.777955="" 212.740682="" 173.037274="" 385.880284="" 385.777955-173.037274="" 385.777955-385.777955c897.777955="" 299.208154="" 724.740682="" 126.17088="" 126.17088z\"\n="" p-id="\"3085\""/>\n</svg>\n"
...
function declension (scheme, count) {
  ...
  // 2, 3, 4, 22, 23, 24, 32 ...
  } else if ((rem10 >= 2 && rem10 <= 10="" 4)="" &&="" (rem100="" <="" ||="" rem100=""> 20)) {
...
</=></scheme></10></http:></feross@feross.org></=></=></=></\n\nthe></\n\nthe></\n\nthe></div></\n\nyou></-></=></anonymous></'></mixins.length;></arr.length;>